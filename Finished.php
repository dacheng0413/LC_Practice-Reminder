        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Remembered Question</h1>
                    <button type="button" class="btn btn-info pull-right" onclick="location.href='TodoList.php';">Back</button>
                ...
                <?php								
                                    ...
                                    $query = "Select LC_ID, date(Input_Date) as date from LeetCode 
