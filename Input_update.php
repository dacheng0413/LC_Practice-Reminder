        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <button type="button" class="btn btn-info pull-right" onclick="location.href='Input.php';">Back</button>
                ...
                <?php
                    ...
                    if($selected_ok == 'false'){
                        $query = "select LC_ID from LeetCode where LC_ID = $selected_LCid";  
                        $result = mysqli_query($db, $query);
                        if ((mysqli_num_rows($result) == 0)){
                            $query = "Insert into leetcode
                            values ('$selected_LCid','$current_date','$current_date','1');";  
                            $result = mysqli_query($db, $query);
                            print "<h3>Your new question $selected_LCid is into the database</h3>";
                        }else{
                        ...
                        if ((mysqli_num_rows($result) == 0)){
                            $query = "Insert into leetcode
                            values ('$selected_LCid','$current_date','$future_date','0');";  
                            $result = mysqli_query($db, $query);
                            print "<h3>Your new question $selected_LCid will be reviewed on $future_date</h3>";
