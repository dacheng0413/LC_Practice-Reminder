        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Update Question</h1>
                    <button type="button" class="btn btn-info pull-right" onclick="history.go(-1)">Back</button>


                </div>
                <?php $selected_LCid = htmlspecialchars($_GET["lcid"]); ?>
                <form action = "TodoList_update.php">
                
                    <div class="form-group">
                        <label>LeetCode Number</label>
                        <input type="text" name="LeetCode" class="form-control" value="<?php print"$selected_LCid";?>" required>
                    </div>
